...
label chapter1:
    ...
    "First, she tried to look down and make out what she was coming to, but it was too dark to see anything; then she looked at the sides of the well,"
...
label chapter1_after_fall:
    ...
    alice "No, I’ll look first"
    alice "and see whether it’s marked 'poison' or not"
    ...
    alice "Well, I’ll eat it, and if it makes me grow larger, I can reach the key;"
    alice "and if it makes me grow smaller, I can creep under the door:"
    alice " so either way I’ll get into the garden, and I don’t care which happens!"

    "She ate a little bit, and said anxiously to herself: "
    alice "Which way? Which way?"
    "she was holding her hand on the top of her head to feel which way it was growing, and she was quite surprised to find that she remained the same size: "
