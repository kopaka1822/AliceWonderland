...
screen credits():
    ...
    use game_menu(_("Credits"), scroll="viewport", bg=None):
        ...
        text "\nLead Scripting:   Kopaka"
        text "Assistant:        XL3xy"
        text "\nVoice Actors:"
        text "  Alice           S. K. Everly"
        text "  Narrator        shinji_w"
        text "  White Rabbit    Adam Wade"
        text "  Cheshire Cat    Andrzej Lesiński"
        text "  Mad Hatter      Rocky Polan"
        text "  March Hare      EdmundVA"
        text "  Dormouse        Lorna Halverson"
        text "  Queen,Crab2     Ostrzalka"
        text "  King            Federico Onofre"
        text "  Duchess,Crab1   Amita Lyssa"
        text "  Caterpillar     MJ McGeachin"
        text "  Gryphon         Outlalli"
        text "  Mock Turtle     Stefan Niko Atkin"
        text "  Alice's Sister  Fizzyemi"
        text "  Cook            Honey Dew"
        text "  Knave,Two       Ryan Sweeney"
        text "  Seven           Allan Min Rivas"
        text "  Duck,Five       Cecil"
        text "  Mouse           Samantha Styduhar"
        text "  Card Soldier    Kai Zhi"
        text "  Bill            SimplySushimi"
        text "  Pat             Reggie LeSabre"
        text "  Lory, Canary    Rea Yoh"
        text "  Pigeon          Rea Yoh"
        text "  Fish            Max Gaudio"
        text "  Frog            Liam Tritaik"
...
style credits_text:
    size 50 color "#fff" font "Consolas.ttf"
...
screen language():
    ...
    use game_menu(_("Language"), scroll="viewport"):
        ...
        vbox:
            ...
            textbutton _("Old English (Voiced)") action [Language(None), Return()] style "stretch_button"
